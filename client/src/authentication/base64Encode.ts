 ...
 */
@injectable()
export class Base64Encode implements IBase64Encode {
    
    constructor(@inject(TYPES.IBrowserStringUtils) private _browserStringUtils: IBrowserStringUtils) { }
     ...
     */
    encode(input: string): string {
        const inputUtf8Arr = this._browserStringUtils.stringToUtf8Arr(input);
